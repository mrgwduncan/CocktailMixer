...
class Search extends React.Component {
  ...
  handleSelectSubmit = e => {
    ...
    switch (this.state.type) {
      case "ingredient":
        this.props.dispatch(fetchByIngredient(this.state.select));
        break;
      case "name":
        this.props.dispatch(fetchByName(this.state.select));
        break;
      case "catagory":
        this.props.dispatch(fetchByCatagory(this.state.select));
        break;
      case "type":
        this.props.dispatch(fetchByType(this.state.select));
        break;
      case "first":
        this.props.dispatch(fetchByFirst(this.state.select));
        break;
      default:
